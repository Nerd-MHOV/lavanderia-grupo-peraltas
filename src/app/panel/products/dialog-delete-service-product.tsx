'use client'
import { actionDeleteServiceProduct } from '@/actions/serverActions/delete-service-product'
...
const DialogDeleteServiceProduct = ({ service }: { service: string }) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Deseja deletar a Marca ?</DialogTitle>
          <DialogDescription>
            {service}
        ...
        <DialogFooter>
          ...
          <ButtonSpin onClick={async () => {
            const response =  actionDeleteServiceProduct(service)
...
export default DialogDeleteServiceProduct