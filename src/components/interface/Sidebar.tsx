                ...
                <ul className='absolute w-full h-full flex flex-col gap-2 '>
                    <li className='list-none mb-12 pointer-events-none mt-1 relative'>
                        <Link href='/panel' className='flex whitespace-nowrap items-center  '>
                            ...
                            <span className=' mt-4 ml-[70px] font-bold text-2xl text-white'>Controle Lavanderia</span>
                        </Link>
                    </li>
                    ...
                    {links.map((link, index) => (
                        <li key={index} className={cn('list-none rounded-l-full w-full text-panelWhite relative ' ,
                            ...
                            `: 'hover:text-gray-300')}
                        >
                            <Link href={link.link} className={cn('flex items-center gap-5 w-full relative')}>
                    ...
                    <li className='flex cursor-pointer items-center bg-[##060814] max-w-f gap-5 w-full text-panelWhite py-3 hover:text-gray-300' onClick={() => {actionLogout()}}>
